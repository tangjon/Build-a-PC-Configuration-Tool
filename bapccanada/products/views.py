...
from .models import GPU, CPU, Monitor, RAM, Motherboard, PowerSupply, Storage, Case, Cooler
...
class PowerSupplyBrowseView(AbstractComponentBrowseView):
    model = PowerSupply
    template_name = 'powerSupplyBrowse.html'
    title = 'Choose a Power Supply'


class CaseBrowseView(AbstractComponentBrowseView):
    model = Case
    template_name = 'caseBrowse.html'
    title = 'Choose a Case'
...
class CoolerBrowseView(AbstractComponentBrowseView):
    model = Cooler
    template_name = 'coolerBrowse.html'
    title = 'Choose a Cooler'
...
class CoolerDetailView(AbstractComponentDetailView):
    model = Cooler
    category = "CPU Cooler"
